...
- **[ide-client](https://lumine-code.github.io/docs.html#services/ide-client)** (`^1.0.0`): consumed to register the Ruff adapter with the editor's language-server client.
