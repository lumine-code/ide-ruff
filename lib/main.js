...
const ruffSettings = () => {
  ...
  return {
    ...
    lint: {
      select: optionalList("select"),
      ignore: optionalList("ignore"),
    },
    codeAction: {
...
module.exports = {
  consumeIdeClient(service) {
      ...
      async resolveServer(context) {
        ...
        return {
          ...
          args: [
            ...(launch.args || []),
            ...configurationArgs({
              allowMagic: setting("allowMagic"),
              fixable: setting("fixable"),
              unfixable: setting("unfixable"),
            }),
          ],
    ...
    for (const key of ["serverPath", "fixable", "unfixable", "useNoqa", "allowMagic"]) {
